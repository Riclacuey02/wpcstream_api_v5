...
$(document).ready(function () {
  ...
  var parent_referer = window.location.ancestorOrigins[0];
  ...
  var get = function get() {
    if (voucher) {
      ...
      $.ajax({
        url: "https://dev.ara-sss.net/api/" + 'domain/iframe-stream-list',
        type: 'POST',
        headers: {
  ...
  var sendLog = function sendLog(data) {
    ...
    if (voucher) {
      ...
      $.ajax({
        url: "https://dev.ara-sss.net/api/" + 'stream-log/create',
        type: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
